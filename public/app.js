...
(async function (util, global, config, Canvas, color, socketStuff) {
  ...
  const gameDraw = (() => {
    ...
    const text = {
      ...
      upgradeNames: [
        // This sets the limit for the number of tanks, along with upgradeKeys below. The default limit is 30.
        TextObj(),
        TextObj(),
        TextObj(),
        TextObj(),
      ...
      upgradeKeys: [
        // This sets the limit for the number of tanks, along with upgradeNames above. The default limit is 30.
        TextObj(),
        TextObj(),
        TextObj(),
        TextObj(),
