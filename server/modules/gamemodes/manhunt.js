...
function checkMan (instance = null, check = true) {
    let condition = entities.filter(entity => entity.team == -1 && (entity.isPlayer || entity.isBot));
    if (!condition.length || (checkTeam(2) && check)) return false;
    ...
    entity.on('dead', () => {
        ...
        checkMan(killer.type == "tank" ? killer : killer.master, false);
    });
    return true;
};

module.exports = { checkMan }