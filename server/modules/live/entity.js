...
class Gun {
  constructor(body, info) {
    ...
    if (info.PROPERTIES != null && info.PROPERTIES.TYPE != null) {
      ...
      this.settings2 =
        info.PROPERTIES.SHOOT_SETTINGS2 == null
          ? []
          : info.PROPERTIES.SHOOT_SETTINGS2;
      this.settings3 =
        info.PROPERTIES.SHOOT_SETTINGS3 == null
          ? []
          : info.PROPERTIES.SHOOT_SETTINGS3;
      this.calculator =
      ...
      this.color =
        info.PROPERTIES.COLOR == null ? this.color : info.PROPERTIES.COLOR;
    ...
    if (info.PROPERTIES != null && info.PROPERTIES.COLOR != null)
      this.color = info.PROPERTIES.COLOR;
    if (info.PROPERTIES != null && info.PROPERTIES.ON_SHOOT != null)
      this.onshoot = info.PROPERTIES.ON_SHOOT;
